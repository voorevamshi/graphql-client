...
public class InventoryClient {
    ...
    public List<Item> viewProducts() {
        String graphQLQuery = "query GetProducts {\n" +
                ...
                "    }\n" +
                "}";
        System.out.println("Executing GraphQL Query (viewProducts):\n" + graphQLQuery);
    ...
    public List<Item> viewProductsByCategory(String category) {
        String graphQLQuery = String.format("query GetProductsByCategory {\n" +
                ...
                "    }\n" +
                "}\n", category);
        System.out.println("Executing GraphQL Query (viewProductsByCategory) with category: " + category + "\n" + graphQLQuery);
    ...
    public Item receiveNewShipment(ItemRequestDTO itemRequest) {
        ...
        System.out.println("Executing GraphQL Mutation (receiveNewShipment) with id: " + itemRequest.getId() +
